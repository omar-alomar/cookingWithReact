            ...
            <div className="recipe-edit-wrapper">
                <div className="recipe-edit__remove-button-container">
                    ...
                    <div className="recipe-edit__details-grid">
                        ...
                        <input type="text" className="recipe-edit__input" name="name" id="name" 
                        ...
                        <input type="text" className="recipe-edit__input" name="cookTime" id="cookTime" 
                        ...
                        <input type="number" className="recipe-edit__input" min="1" name="servings" id="servings" 
                        ...
                        <textarea name="instructions" className="recipe-edit__input"id="instructions" 
